...
var glslHighlightRules = function () 
{
    var keywords = (
        ...
        "if|else|in|out|inout|lowp|mediump|highp|precision|invariant|discard|return"
    );
    ...
    // Attributes
    var attributes = (
        "Slider|slider|Range|range|Float|float|Field|field|Enum|enum|Dropdown|dropdown|" +
        "Color|color|vector|Vector|toggle|Toggle|Bool|bool|Check|check|Checkbox|checkbox"
    );

    // Types
    var types = (
        "float|int|void|bool|true|false|" +
        "mat2|mat3|mat4|vec2|vec3|vec4|ivec2|ivec3|ivec4|bvec2|bvec3|bvec4|sampler2D|" +
        "float2x2|float3x3|float4x4|float2|float3|float4|int2|int3|int4|bool2|bool3|bool4|" +
        "samplerCube|struct"
    );
    ...
    var keywordMapper = this.createKeywordMapper({
        "variable.language": "this",
        "support.type.attribute": attributes,
        "keyword": keywords,
        "constant.language": functions,
        "support.constant": types,
        "storage.modifier": constant
    }, "identifier");
